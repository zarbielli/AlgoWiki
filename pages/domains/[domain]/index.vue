...
const [
    ...
    useFetch(`${useRuntimeConfig().public.API_URL}/domains/` + route.params.domain),
    ...
    <main class="">
        <section class="bg-[#ABD7E0] py-8 px-2">
            <div class="max-w-7xl mx-auto">
                ...
                <div class="max-w-proe my-4 ">
                    <p class="text-justify mb-2" v-for="paragrah in domain.domainDescription.split('\n')">
                        <span v-html="$renderMathString(paragrah)"> </span>
                    </p>
                </div>
                ...
                <li v-for="(family, idx) in filteredFamilies" :key="idx" class="col-span-1 flex shadow-sm rounded-md">
                    ...
                    <div
                        ...
                        <div class="flex-1 px-4 py-2 text-sm truncate">
                            <NuxtLink :to="'/domains/' + route.params.domain + '/families/' + family.familySlug"
